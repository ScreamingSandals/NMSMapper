...
public class MainPage extends AbstractPage {
    ...
    protected void constructContent(ContainerTag div) {
        div.with(
                div(
                        div(
                                h5("Welcome on the NMS Mapping browser page. This page allows you to browse the server-side mappings for Minecraft: Java Edition and compare between different mappings and versions.").withClass("card-title"),
                                p("This page mainly focuses on Spigot, its forks, and Spigot-Forge hybrids like MohistMC. That means this page doesn't contain information about things excluded in the Spigot mappings (eg. package-info). This page also doesn't contain any information about lambda's, anonymous classes or synthetic members (they are generated by compiler, they are not in the source code)"),
                                p("On the overview page of every version you can find licenses for all the mappings and links to their origin."),
                                p(
                                        text("If the class or package name contains ${V}, it means there should be the CraftBukkit version string (eg. v1_15_R1, v1_16_R3). If you need the string (you are not using our gradle plugin), please check out this "),
